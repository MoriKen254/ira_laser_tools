...
void LaserscanMerger::laserscan_topic_parser()
{
  ...
  std::cout << laserscan_topics << std::endl;
  ...
  input_topics.push_back("base_scan");
  input_topics.push_back("base_scan2");
    std::cout << "input_topics.size(): " << input_topics.size() << std::endl;
